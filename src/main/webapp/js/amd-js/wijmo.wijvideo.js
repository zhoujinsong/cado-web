...
(function (wijmo) {
    ...
    */
    (function (video) {
        "use strict";
        var $ = jQuery, widgetName = "wijvideo", wijvideoClass = "wijmo-wijvideo", wijvideoWrapperClass = "wijmo-wijvideo-wrapper", wijvideoControlsClass = "wijmo-wijvideo-controls", wijvideoPlayClass = "wijmo-wijvideo-play", wijvideoIndexClass = "wijmo-wijvideo-index", wijvideoIndexSliderClass = "wijmo-wijvideo-index-slider", wijvideoTimerClass = "wijmo-wijvideo-timer", wijvideoVolumeClass = "wijmo-wijvideo-volume", wijvideoVolumeContainerClass = "wijmo-wijvideo-volume-container", wijvideoVolumeSliderClass = "wijmo-wijvideo-volumeslider", wijvideoFullScreen = "wijmo-wijvideo-fullscreen", wijvideoContainerFullScreenClass = "wijmo-wijvideo-container-fullscreen";
        ...
        var wijvideo = (function (_super) {
            ...
            wijvideo.prototype._showToolTip = function (e) {
                ...
                this.$seekSlider.wijtooltip("showAt", { x: mousePositionX, y: mousePositionY - 10 });
            };
