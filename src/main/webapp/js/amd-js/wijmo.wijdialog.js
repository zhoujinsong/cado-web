        ...
        var wijdialog = (function (_super) {
            ...
            */
            ...
            wijdialog.prototype._attachDraggableResizableEvent = function () {
                ...
                if (o.draggable && uiDialog.draggable) {
                    uiDialog.bind("dragstop", function (event) {
                ...
                if (o.resizable && uiDialog.resizable) {
                    uiDialog.bind("resizestop", function (event) {
                        self._saveNormalState();
                        self._destoryIframeMask();
                    }).bind("resizestart", function (event) {
                        self._createIframeMask();
            ...
            */
            wijdialog.prototype.minimize = function () {
                var self = this, dlg = self.uiDialog, o = self.options, wijCSS = o.wijCSS, miniZone = null, $from = $("<div></div>"), $to = $("<div></div>"), defaultZone, scrollTop, top, originalPosition, originalSize = { width: undefined, height: undefined }, position, size = { width: undefined, height: undefined }, content = "uiDialog", originalState;
            ...
            */
            wijdialog.prototype.maximize = function () {
                var self = this, w = $(window), originalPosition, originalSize = { width: undefined, height: undefined }, position, size = { width: undefined, height: undefined }, state;
            ...
            wijdialog.prototype._saveNormalState = function () {
                ...
                if (!self.maximized) {
                    self.normalWidth = parseFloat(dialog.css("width"));
                    self.normalLeft = parseFloat(dialog.css("left"));
                    self.normalTop = parseFloat(dialog.css("top"));
                    self.normalHeight = parseFloat(dialog.css("height"));

                    self.normalInnerHeight = parseFloat(ele.css("height"));
                    self.normalInnerWidth = parseFloat(ele.css("width"));
                    self.normalInnerMinWidth = parseFloat(ele.css("min-width"));
                    self.normalInnerMinHeight = parseFloat(ele.css("min-height"));
                }
            };
            ...
            */
            wijdialog.prototype.restore = function () {
                var self = this, dlg = self.uiDialog, originalPosition, originalSize = { width: undefined, height: undefined }, position, size = { width: undefined, height: undefined }, $from = $("<div></div>"), $to = $("<div></div>"), content = "uiDialog", state;
            ...
            */
            wijdialog.prototype.open = function () {
                ...
                if (!self.innerFrame) {
                    ...
                    if (self._isIE9()) {
                        effects = ["blind", "bounce", "clip", "drop", "explode", "fold", "size", "shake", "slide", "transfer"];
            ...
            */
            ...
            wijdialog.prototype._closeDialogHelper = function () {
                if (this.innerFrame) {
                    this.innerFrame.attr("src", "");
                    if (this.minimized) {
                        this.uiDialogTitlebar.hide();
                    }
                }
                if (this.disabledDiv && this.options.disabled) {
                    this.disabledDiv.hide();
                }
            };
