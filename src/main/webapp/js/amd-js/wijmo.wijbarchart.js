    ...
    */
    (function (chart) {
        ...
        */
        ...
        wijbarchart.prototype.options = $.extend(true, {}, chart.wijchartcore.prototype.options, new wijbarchart_options());
        ...
        var BarChartRender = (function () {
            ...
            BarChartRender.prototype.playAnimation = function (animatedBars) {
                var self = this, o = self.options, animation = o.animation, animated = animation && animation.enabled, inverted = o.horizontal, trendLines = self.fields.trendLines, seriesTransition = o.seriesTransition, duration, easing, barsAttr = [], diffAttr, chartLabelStyle = o.chartLabelStyle, extremeValue = {
                ...
                if (animated) {
                    ...
                    if (trendLines && trendLines.length) {
                        chart.TrendlineRender.playAnimation(duration, easing, seriesTransition, self.animationSet, o.bounds, self.paths, self.fieldsAniPathAttr, null, o.axis, extremeValue);
                    }
