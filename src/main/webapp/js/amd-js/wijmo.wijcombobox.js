 ...
 */
var wijmo;
define(["./wijmo.widget", "./wijmo.wijutil", "./wijmo.wijlist"], function () { 
        ...
        var wijcombobox = (function (_super) {
            ...
            */
            ...
            wijcombobox.prototype._setOption = function (key, value) {
                var self = this, ele, input, items, inputWrapper, cancelSelect, wijCSS = this.options.wijCSS, label = self._label, triggerPadding, oldSelectedIndex, newSelectedItem, oldDisabled, oldSelectedItem = null, triggerWidth = 0, o = self.options;
