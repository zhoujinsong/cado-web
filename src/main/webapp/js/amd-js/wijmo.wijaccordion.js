        ...
        var wijaccordion = (function (_super) {
            ...
            */
            wijaccordion.prototype.activate = function (index) {
                ...
                prevHeader = $(jQuery.grep(headers.get(), function (a) {
        ...
        $.extend($.wijmo.wijaccordion, {
            animations: {
                ...
                slide: function (options, additions) {
                    ...
                    var overflow = options.toShow.css('overflow'), percentDone = 0, showProps = {}, hideProps = {}, toShowCssProps, fxAttrs = options.horizontal ? ["width", "paddingLeft", "paddingRight"] : ["height", "paddingTop", "paddingBottom"], originalWidth, s = options.toShow;
                    ...
                    $.each(fxAttrs, function (i, prop) {
                        ...
                        if (!options.horizontal && prop === "height") {
                            showProps[prop] = $.wijmo.wijaccordion.animations._parseWidth(options.toShow.css(prop));
