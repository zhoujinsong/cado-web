    ...
    (function (evcal) {
        ...
        var wijevcal = (function (_super) {
            ...
            wijevcal.prototype._setOptionInternal = function (key, value) {
                var o = this.options, culture, calendarCulture;
                switch (key) {
                    case "dataSource":
                        o.dataSource = value;
                    ...
                    case "cultureCalendar":
                        ...
                        this._resetCulture();
                        this.element.find(".wijmo-wijdatepager").wijdatepager("option", key, value);
                        if (this._editEventDialog) {
                            this._editEventDialog.find(".wijmo-wijinput-date").wijinputdate("option", key, value);
                        }
                        this.element.find(".wijmo-wijcalendar").wijcalendar("option", key, value);
                        this._redrawActiveView(); // fix for 23766
                        break;
                    case "calendar":
                        this.element.find(".wijmo-wijcalendar").wijcalendar("option", value);
                    ...
                    case "firstDayOfWeek":
                        if (o[key] !== value) {
                            ...
                            if (culture && culture.calendar) {
                                ...
                                calendarCulture = this.element.find(".wijmo-wijcalendar").data("wijmo-wijcalendar");
            ...
            wijevcal.prototype._onSelectedDatesChanged = function () {
                ...
                this._trigger("selectedDatesChanged", null, { selectedDates: o.selectedDates });
                this._renderActiveView();
                this._updateTitleText();
            };
            ...
            */
            ...
            wijevcal.prototype._create = function () {
                ...
                this.element.addClass("wijmo-wijevcal wijmo-wijev " + o.wijCSS.widget + " " + o.wijCSS.helperReset + " " + o.wijCSS.stateDefault);
                ...
                $("<div class=\"wijmo-wijev-view-container\">" + "<div class=\"wijmo-wijev-leftpane wijmo-wijev-viewdetails " + o.wijCSS.content + " wijmo-wijev-day-details\">" + "<div class=\"wijmo-wijev-leftpane-inner\">" + "<div class=\"wijmo-wijev-daycalendar\"></div>" + "<div class=\"wijmo-wijev-monthday-container\">" + "<div class=\"wijmo-wijev-monthday-label\">...</div>" + "<div class=\"wijmo-wijev-fulldate-label\">" + this.localizeString("activityLoading", "Loading...") + "</div>" + "<div class=\"wijmo-wijev-year-label\">...</div>" + "</div>" + "<div class=\"wijmo-wijev-agenda-container " + o.wijCSS.content + " " + o.wijCSS.cornerAll + " " + o.wijCSS.helperClearFix + "\"></div>" + "</div>" + "</div>" + "<div class=\"wijmo-wijev-leftpane wijmo-wijev-viewdetails " + o.wijCSS.content + " wijmo-wijev-list-details\">" + "<div class=\"wijmo-wijev-leftpane-inner\">" + "<div class=\"wijmo-wijev-agenda-container " + o.wijCSS.content + " " + o.wijCSS.cornerAll + " " + o.wijCSS.helperClearFix + "\">&nbsp;" + "</div>" + "</div>" + "</div>" + "<div class=\"wijmo-wijev-rightpane\">" + "&nbsp;</div>" + "</div>").appendTo(this.element);
                ...
                $("<div class=\"wijmo-wijev-navigationbar " + o.wijCSS.header + " " + o.wijCSS.cornerBottom + " " + o.wijCSS.helperClearFix + "\">" + "<a class=\"wijmo-wijev-today\">" + this.localizeString("buttonToday", "today") + "</a>" + "<div class=\"wijmo-wijev-datepager\">" + "</div>" + "</div>").appendTo(this.element);
                    ...
                    this._editEventDialog.wijpopup({
                        ...
                        shown: $.proxy(function (e) {
                            ...
                            if (!this._dropDownInitialized) {
                                ...
                                this._editEventDialog.find(".wijmo-wijev-calendar").wijdropdown({ "unfocus": superPanelUnFocus }).bind("change", function (e) {
            ...
            */
            ...
            wijevcal.prototype._destroyInternal = function () {
                var o = this.options;
                this.element.removeClass("wijmo-wijev wijmo-wijevcal " + o.wijCSS.widget + " " + o.wijCSS.helperReset);
            ...
            */
            wijevcal.prototype.showEditEventDialog = function (appt, offsetElement, e) {
                var o = this.options, masterAppt, parentColumn, startdt, popupWijdget, position, targetCell = offsetElement ? $(offsetElement) : (e ? $(e.target) : null);
            ...
            wijevcal.prototype._renderDayView = function () {
                ...
                if (!this._templateDayColumn) {
                    ...
                    this._templateDayHeader = $("<div class=\"wijmo-wijev-dayheadercolumn " + o.wijCSS.content + "\">" + "<div class=\"wijmo-wijev-allday-cell " + o.wijCSS.content + "\">" + "<div class=\"wijmo-wijev-daylabel\">3 Monday</div>" + "</div>" + "</div>");
                }
            ...
            wijevcal.prototype._getEventMarkup = function (appt) {
                return "<div class=\"wijmo-wijev-appointment wijmo-wijev-event-color-" + (appt.color || "default") + " " + this._eventIdToCssClass(appt.id) + "\">" + "<div class=\"wijmo-wijev-content\"><div class=\"wijmo-wijev-title\">" + this._formatString(this.options.eventTitleFormat, appt.start, appt.end, appt.subject, appt.location, "", appt.description) + "</div></div>" + "<div class=\"wijmo-wijev-resizer\">" + "<div class=\"" + this.options.wijCSS.icon + " " + this.options.wijCSS.iconHGripSolid + "\">" + "&nbsp;</div></div>" + "</div>";
            };
            ...
            */
            ...
            wijevcal.prototype._renderMonthView = function () {
                var o = this.options, selectedDate = o.selectedDate, firstDayOfWeek = o.firstDayOfWeek, isToday = false, isOtherMonth = false, curDate, startDate, endDate, todayDate = new Date(), curColumnInd, curRowInd, skipNextBorder = false, containerClass, sCols = ["", "", "", "", "", "", ""], s, i, monthview = this.element.find(".wijmo-wijev-view.wijmo-wijev-monthview"), monthviewinner, dayHeaderFormat = o.dayHeaderFormat, firstRowDayHeaderFormat = o.firstRowDayHeaderFormat;
                if (!selectedDate) {
