    ...
    */
    (function (chart) {
        ...
        */
        ...
        wijscatterchart.prototype.options = $.extend(true, {}, chart.wijchartcore.prototype.options, new wijscatterchart_options());
        ...
        var ScatterChartRender = (function () {
            ...
            ScatterChartRender.prototype._init = function () {
                ...
                this.animationSet = this.options.canvas.set();
            };
            ...
            ScatterChartRender.prototype.paintDefaultChartLabel = function (x, y, val) {
                var o = this.options, textStyle = $.extend(true, {}, o.textStyle, o.chartLabelStyle), text, chartLabelFormatString = o.chartLabelFormatString, dcl;
            ...
            ScatterChartRender.prototype.paintScatters = function () {
                ...
                $.each(seriesList, function (i, series) {
                    ...
                    if (series.isTrendline) {
                        chart.TrendlineRender.renderSingleTrendLine(series, seriesStyles[i], seriesHoverStyles[i], self.options.axis, undefined, self.fieldsAniPathAttr, self.options.animation, self.options.seriesTransition, i, bounds, self.options.canvas, self.paths, shadowPaths, self.animationSet, self.aniPathsAttr, wijCSS, self.seriesEles);
                        return true;
                    }
                    series = $.extend(true, {
                        visible: true,
            ...
            ScatterChartRender.prototype.playAnimation = function () {
                var self = this, o = self.options, ani = o.animation, element = self.element, bgColor = element.css("background-color"), extremeValue = {
                ...
                if (ani.enabled) {
                    ...
                    if (self.paths && self.paths.length) {
                        chart.TrendlineRender.playAnimation(ani.duration, ani.easing, o.seriesTransition, self.animationSet, o.bounds, self.paths, self.fieldsAniPathAttr, null, o.axis, extremeValue);
                    }
                } else {
                    if (self.clipRect.getCSS) {
        ...
        (function (render) {
            ...
            var VMLElement = (function (_super) {
                ...
                VMLElement.prototype.attr = function (hash, val) {
                    var key, value, i, self = this, element = self.element || {}, elemStyle = element.style, nodeName = element.nodeName, symbolName = self.symbolName, renderer = self.renderer, childNodes, hasSetSymbolSize, shadows = self.shadows, skipAttr, convertedPath, ret = self;
